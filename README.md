...
## V9
- Thêm tùy chọn `Hiện buổi chiều`.
- Bỏ chọn để ẩn toàn bộ các hàng buổi Chiều trên màn hình và bản in.
- Khi ẩn Chiều, các cột lớp không còn tiết nào cũng tự động biến mất.
- Giữ riêng các tùy chọn Hiện buổi tối và Hiện Chủ nhật.


## V10 - Danh sách giáo viên tự động
- Sau khi dán link Google Sheets, app tự quét toàn bộ vùng lớp 10A1 đến 12A5.
- Tự lấy các tên giáo viên xuất hiện trong các ô `Môn - Giáo viên`.
- Tên trùng được loại bỏ.
